...
function App() {
  return (
    <>
      <Link to="/" >Home</Link> | {" "}
      <Link to="/ex07" >예제 7</Link> | {" "}
      <Link to="/ex08" >예제 8</Link> | {" "}
      <Link to="/ex09" >예제 9</Link> | {" "}
      <Link to="/ex10" >예제 10</Link> | {" "}
      <Link to="/ex11" >예제 11</Link> | {" "}
      <Link to="/ex12" >예제 12</Link> | {" "}
      <Link to="/ex13" >예제 13</Link> | {" "}
      <Link to="/ex14" >예제 14</Link> | {" "}
