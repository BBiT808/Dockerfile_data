    ...
    <section id ="projects" section className="projects-section">
      ...
      <div className="project-container">
        <div className="project-description">
          ...
          <p>
            전자 도서관 시스템을 구현한<br />미니 팀 프로젝트로써 책 검색, 대출/반납,<br />사용자 관리 기능 등을<br />포함했습니다.
          </p>
      ...
      <div className="project-container">
        <div className="project-description">
          ...
          <p>
            부산광역시의 7개 구(남구, 동래구, 부산진구,<br />북구, 사상구, 사하구, 해운대구)의<br />소비자 물가 데이터를 분석하고<br />시각화하여 보여주는 웹서비스 입니다.
          </p>
          <div className="project-links">
      ...
      <div className="project-container">
        <div className="project-description">
          <h3>Github main</h3>
          <p>
            교육 동안 배운 기술 스택을<br />각 종류별로 정리했습니다.<br />다양한 기술을 연마할 수 있었던<br />소중한 기간이었습니다.
          </p>
          <div className="project-links">
